...
class _UserRemoteDataSource implements UserRemoteDataSource {
  ...
  @override
  Future<ApiWrapper<UserModel>> getCurrentUser() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiWrapper<UserModel>>(
    ...
    late ApiWrapper<UserModel> _value;
    try {
      _value = ApiWrapper<UserModel>.fromJson(
        _result.data!,
  ...
  Future<ApiWrapper<UserModel>> updateCurrentUser(
    ...
    _data.addAll(userDetailUpdateReq.toJson());
    final _options = _setStreamType<ApiWrapper<UserModel>>(
